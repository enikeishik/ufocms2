...
class UIBackup extends UI
{
    ...
    protected function setMainTabs()
    {
        ...
        $tab = '<a href="?' . $this->config->paramsNames['coreModule'] . '=' . $this->params->coreModule . '&' . $this->config->paramsNames['subModule'] . '=backup" class="current" title="резервные копии системы">резерв.копии</a>';
