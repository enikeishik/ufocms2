...
<?php } else { ?>
    ...
    <div>Через пять секунд страница будет перенаправлена на <a href="<?=$path?>">предыдущую страницу</a>.</div>
    <script type="text/javascript">setTimeout("location.href='<?=$path?>'", 5000);</script>
<?php } ?>
</div>
