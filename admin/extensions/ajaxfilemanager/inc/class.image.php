<?php
    ...
    function getGDInfo($versionOnly = false)
    {
        ...
        //fix JPG|JPEG difference
        if (isset($outputs['JPG Support']) && $outputs['JPG Support']) {
            $outputs['JPEG Support'] = true;
        }
        if (isset($outputs['JPEG Support']) && $outputs['JPEG Support']) {
