...
{ return baseUrl;}
}; function initAfterListingLoaded() {setTimeout(initAfterListingLoaded_, 500);} function initAfterListingLoaded_()
...
{ info = files[num];}
$('#returnCurrentUrl').hide(); $('#returnCurrentFolderUrl').hide(); 
if(info.type=="folder")
...
$('#folderFieldSet').css('display', ''); $('#fileFieldSet').css('display', 'none');
if('root'!=type)
{ if(typeof(selectFolder) != 'undefined')
{ $('#selectCurrentFolderUrl').unbind('click').click(function()
{ selectFolder(info.url);});$('#returnCurrentFolderUrl').show();}else
{ $('#returnCurrentFolderUrl').hide();}};}else
